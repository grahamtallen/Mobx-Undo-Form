...
num){
this.colorIndex=num}},{key:'currentColor',get:function get(){var colors=this.colors,colorIndex=this.colorIndex;return colors[colorIndex]}}]);return ColorStore})(),(_descriptor5=_applyDecoratedDescriptor(_class3.prototype,'colors',[_mobx.observable],{enumerable:true,initializer:function initializer(){return ["blue","red","green"]}}),_descriptor6=_applyDecoratedDescriptor(_class3.prototype,'colorIndex',[_mobx.observable],{enumerable:true,initializer:function initializer(){return 0}}),_applyDecoratedDescriptor(_class3.prototype,'currentColor',[_mobx.computed],Object.getOwnPropertyDescriptor(_class3.prototype,'currentColor'),_class3.prototype),_applyDecoratedDescriptor(_class3.prototype,'changeColor',[_mobx.action],Object.getOwnPropertyDescriptor(_class3.prototype,'changeColor'),_class3.prototype),_applyDecoratedDescriptor(_class3.prototype,'setColor',[_mobx.action],Object.getOwnPropertyDescriptor(_class3.prototype,'setColor'),_class3.prototype)),_class3);var 



NumberStore=(_class5=(function(){function NumberStore(){_classCallCheck(this,NumberStore);_initDefineProp(this,'currentNumber',_descriptor7,this)}_createClass(NumberStore,[{key:'add',value:function add()


{
this.currentNumber++}}]);return NumberStore})(),(_descriptor7=_applyDecoratedDescriptor(_class5.prototype,'currentNumber',[_mobx.observable],{enumerable:true,initializer:function initializer(){return 2}}),_applyDecoratedDescriptor(_class5.prototype,'add',[_mobx.action],Object.getOwnPropertyDescriptor(_class5.prototype,'add'),_class5.prototype)),_class5);var 
